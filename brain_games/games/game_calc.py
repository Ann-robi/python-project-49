...
def get_game():
    """Создает и возвращает вопрос со случайным арифметическим
    выражением и верный ответ для одного раунда.
    """
...
def is_calculator(num_one, num_two, operator):
    """Возвращает результат вычислений выражения
    в вопросе в зависимости от оператора.
    """
    if operator == '+':
